...
@Component({
  selector: 'app-curriculum-development',
  templateUrl: './curriculum-development.component.html',
  styleUrl: './curriculum-development.component.scss'
})
export class CurriculumDevelopmentComponent implements OnInit {
  public readonly UUID_SECTION = '939db4e8-0856-4aad-b3aa-747e2dba76d9';
