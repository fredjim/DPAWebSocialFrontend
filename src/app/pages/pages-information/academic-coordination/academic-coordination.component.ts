...
@Component({
  selector: 'app-academic-coordination',
  templateUrl: './academic-coordination.component.html',
  styleUrl: './academic-coordination.component.scss'
})
export class AcademicCoordinationComponent implements OnInit {
  public readonly UUID_SECTION = '923ab4e8-0856-4aad-b3aa-747e2dba76d9';
