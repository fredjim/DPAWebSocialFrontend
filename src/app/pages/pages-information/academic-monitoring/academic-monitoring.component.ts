...
@Component({
  selector: 'app-academic-monitoring',
  templateUrl: './academic-monitoring.component.html',
  styleUrl: './academic-monitoring.component.scss'
})
export class AcademicMonitoringComponent implements OnInit { 
  public readonly UUID_SECTION = '944ib4e8-0856-4aad-b3aa-747e2dba76d9';
