...
@Component({
  selector: 'app-alternative-graduation',
  templateUrl: './alternative-graduation.component.html',
  styleUrl: './alternative-graduation.component.scss'
})
export class AlternativeGraduationComponent implements OnInit {
  public readonly UUID_SECTION = '943ib4e8-0856-4aad-b3aa-747e2dba76d9';
