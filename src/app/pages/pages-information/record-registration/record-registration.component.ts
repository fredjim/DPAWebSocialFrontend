...
@Component({
  selector: 'app-record-registration',
  templateUrl: './record-registration.component.html',
  styleUrl: './record-registration.component.scss'
})
export class RecordRegistrationComponent implements OnInit {
  public readonly UUID_SECTION = '945ib4e8-0856-4aad-b3aa-747e2dba76d9';
