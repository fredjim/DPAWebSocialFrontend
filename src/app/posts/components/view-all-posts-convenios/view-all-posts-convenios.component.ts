...
@Component({
  selector: 'app-view-all-posts-convenios',
  templateUrl: './view-all-posts-convenios.component.html',
  styleUrl: './view-all-posts-convenios.component.scss'
})
export class ViewAllPostsConveniosComponent implements OnInit, OnDestroy {
  ...
  authenticated: boolean = false;
    ...
    ngOnInit(){
      ...
      this.postService.getPostsByType('CONVENIOS')
