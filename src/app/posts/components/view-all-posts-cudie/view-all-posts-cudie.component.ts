...
@Component({
  selector: 'app-view-all-posts-cudie',
  templateUrl: './view-all-posts-cudie.component.html',
  styleUrl: './view-all-posts-cudie.component.scss'
})
export class ViewAllPostsCudieComponent implements OnInit, OnDestroy {
  ...
  authenticated: boolean = false;
        ...
        ngOnInit(){
          ...
          this.postService.getPostsByType('CUDIE')
